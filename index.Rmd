...
- Notable points of interest in the dataset are that 'r ' contains the most confirmed
- cases in the world, with 'r ' containing the least
...
worldCases(data, sf::st_read("data/countries.geojson", quiet = TRUE))
```
