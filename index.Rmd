...
get_info(data)
```
- country with most cases `r get_info(data)[0]`
- country with least cases `r get_info(data)[1]`
- 3 more points of interest `r get_info(data)[2]`
- Notable points of interest in the dataset are that 'r ' contains the most confirmed `r get_info(data)[3]`
- cases in the world, with 'r ' containing the least. `r get_info(data)[4]`
